module gcd (clk,
 ...
 OAI21_X1 _387_ (.A(_066_),
    ...
    .B2(net33),
    .ZN(_000_));
 XOR2_X1 _389_ (.A(net261),
    .B(net242),
    .Z(net37));
 INV_X1 _390_ (.A(net261),
    .ZN(_072_));
 NAND2_X2 _391_ (.A1(_072_),
    .A2(net242),
    .ZN(_073_));
 XOR2_X2 _393_ (.A(net234),
    .B(net251),
    .Z(_075_));
 XNOR2_X2 _394_ (.A(_075_),
    .B(_073_),
    .ZN(net44));
 ...
 NOR3_X4 _396_ (.A1(_076_),
    ...
    .ZN(_077_));
 OAI21_X4 _397_ (.A(net392),
    .B1(\dpath.a_lt_b$in0[0] ),
    .B2(_076_),
    .ZN(_078_));
 AOI21_X4 _398_ (.A(net196),
    .B1(net195),
    .B2(net234),
    .ZN(_079_));
 ...
 AOI21_X4 _413_ (.A(_090_),
    ...
    .B2(_079_),
    .ZN(_092_));
 XOR2_X2 _415_ (.A(\dpath.a_lt_b$in0[4] ),
    .B(\dpath.a_lt_b$in1[4] ),
    .Z(_094_));
 XOR2_X2 _416_ (.A(net182),
    .B(net219),
    .Z(net47));
 XOR2_X2 _418_ (.A(\dpath.a_lt_b$in0[5] ),
    .B(\dpath.a_lt_b$in1[5] ),
    .Z(_096_));
 NOR2_X2 _419_ (.A1(net231),
    .A2(_092_),
    .ZN(_097_));
 NAND2_X1 _420_ (.A1(net231),
    .A2(_092_),
    .ZN(_098_));
 AOI21_X2 _421_ (.A(_097_),
    ...
    .B2(net248),
    .ZN(_099_));
 XOR2_X1 _422_ (.A(net218),
    .B(_099_),
    .Z(net48));
 INV_X1 _423_ (.A(net231),
    .ZN(_100_));
 ...
 AOI211_X2 _430_ (.A(_103_),
    ...
    .C2(_090_),
    .ZN(_107_));
 XNOR2_X1 _431_ (.A(net228),
    .B(net246),
    .ZN(_108_));
 XNOR2_X2 _432_ (.A(net489),
    .B(net217),
    .ZN(net49));
 XNOR2_X1 _433_ (.A(\dpath.a_lt_b$in1[7] ),
    .B(net245),
    .ZN(_109_));
 NOR2_X2 _434_ (.A1(net227),
    .A2(net489),
    .ZN(_110_));
 INV_X1 _435_ (.A(\dpath.a_lt_b$in0[6] ),
    .ZN(_111_));
 AOI21_X2 _436_ (.A(net216),
    .B1(net227),
    .B2(net489),
    .ZN(_112_));
 ...
 NOR3_X1 _463_ (.A1(_127_),
    ...
    .A3(_124_),
    .ZN(_136_));
 NOR2_X1 _464_ (.A1(net193),
    .A2(_136_),
    .ZN(_137_));
 AND2_X4 _465_ (.A1(_135_),
    .A2(net180),
    .ZN(_138_));
 XNOR2_X2 _466_ (.A(_138_),
    .B(net211),
    .ZN(_139_));
 XNOR2_X2 _467_ (.A(net175),
    .B(net260),
    .ZN(net38));
 ...
 NOR2_X1 _470_ (.A1(\dpath.a_lt_b$in1[11] ),
    .A2(_141_),
    .ZN(_142_));
 INV_X1 _471_ (.A(net240),
    .ZN(_143_));
 NOR2_X1 _472_ (.A1(_143_),
    .A2(net258),
    .ZN(_144_));
 NOR2_X1 _473_ (.A1(net192),
    .A2(_144_),
    .ZN(_145_));
 NAND2_X1 _474_ (.A1(net212),
    .A2(net259),
    .ZN(_146_));
 INV_X1 _475_ (.A(net259),
    .ZN(_147_));
 NAND2_X1 _476_ (.A1(net241),
    .A2(_147_),
    .ZN(_148_));
 NAND3_X2 _477_ (.A1(_135_),
    .A2(_137_),
    .A3(_148_),
    .ZN(_149_));
 AND2_X4 _478_ (.A1(_149_),
    .A2(net191),
    .ZN(_150_));
 XNOR2_X2 _479_ (.A(net174),
    .B(net183),
    .ZN(net39));
 ...
 OAI221_X4 _486_ (.A(_153_),
    ...
    .C2(net210),
    .ZN(_157_));
 XNOR2_X1 _488_ (.A(net238),
    .B(net256),
    .ZN(_159_));
 XOR2_X2 _489_ (.A(net207),
    .B(net336),
    .Z(net40));
 ...
 INV_X1 _492_ (.A(\dpath.a_lt_b$in1[12] ),
    .ZN(_162_));
 OAI21_X1 _493_ (.A(net257),
    .B1(_157_),
    .B2(net205),
    .ZN(_163_));
 NAND2_X1 _494_ (.A1(net205),
    .A2(_157_),
    .ZN(_164_));
 AND2_X2 _495_ (.A1(_163_),
    .A2(_164_),
    .ZN(_165_));
 XOR2_X2 _496_ (.A(net206),
    .B(_165_),
    .Z(_166_));
 INV_X1 _497_ (.A(_166_),
    .ZN(net41));
 OAI21_X4 _498_ (.A(net177),
    .B1(net268),
    .B2(_154_),
    .ZN(_167_));
 ...
 INV_X1 _500_ (.A(net256),
    .ZN(_169_));
 NAND2_X1 _501_ (.A1(net203),
    .A2(net201),
    .ZN(_170_));
 NAND2_X1 _502_ (.A1(net237),
    .A2(net201),
    .ZN(_171_));
 AOI221_X1 _503_ (.A(_167_),
    ...
    .C2(net209),
    .ZN(_172_));
 NAND2_X1 _504_ (.A1(net203),
    .A2(net238),
    .ZN(_173_));
 NAND2_X1 _505_ (.A1(net237),
    .A2(net238),
    .ZN(_174_));
 AOI221_X1 _506_ (.A(_167_),
    ...
    .C2(net209),
    .ZN(_175_));
 AOI21_X1 _507_ (.A(net203),
    .B1(net238),
    .B2(net202),
    .ZN(_176_));
 INV_X1 _508_ (.A(net237),
    .ZN(_177_));
 OAI22_X1 _509_ (.A1(net257),
    .A2(_173_),
    .B1(_176_),
    .B2(_177_),
    .ZN(_178_));
 ...
 NAND2_X1 _515_ (.A1(\dpath.a_lt_b$in1[14] ),
    .A2(_183_),
    .ZN(_184_));
 NAND2_X1 _516_ (.A1(net189),
    .A2(net188),
    .ZN(_185_));
 XNOR2_X2 _517_ (.A(_185_),
    .B(_179_),
    .ZN(_186_));
 ...
 XNOR2_X2 _530_ (.A(_196_),
    .B(_197_),
    .ZN(net43));
 NOR2_X1 _531_ (.A1(_068_),
    .A2(net8),
    .ZN(_198_));
 NAND2_X1 _533_ (.A1(net262),
    .A2(_003_),
    .ZN(_200_));
 OAI221_X1 _534_ (.A(_068_),
    .B1(_073_),
    .B2(_200_),
    .C1(net262),
    .C2(_072_),
    .ZN(_201_));
 AND3_X1 _535_ (.A1(net261),
    .A2(net242),
    .A3(_003_),
    .ZN(_202_));
 ...
 AOI21_X1 _537_ (.A(_203_),
    ...
    .B2(_178_),
    .ZN(_204_));
 NOR2_X1 _538_ (.A1(net238),
    .A2(_169_),
    .ZN(_205_));
 NAND2_X1 _539_ (.A1(net254),
    .A2(_205_),
    .ZN(_206_));
 NAND2_X1 _540_ (.A1(net236),
    .A2(_206_),
    .ZN(_207_));
 ...
 NAND2_X1 _547_ (.A1(_213_),
    .A2(_193_),
    .ZN(_214_));
 OAI21_X2 _548_ (.A(_211_),
    .B1(_212_),
    .B2(_214_),
    .ZN(_215_));
 AND2_X4 _549_ (.A1(_210_),
    .A2(_215_),
    .ZN(_216_));
 ...
 NAND2_X4 _551_ (.A1(_210_),
    .A2(_215_),
    .ZN(_218_));
 NOR2_X1 _553_ (.A1(net223),
    .A2(_073_),
    .ZN(_220_));
 NOR2_X1 _554_ (.A1(_072_),
    .A2(net242),
    .ZN(_221_));
 OAI21_X1 _555_ (.A(net166),
    .B1(_220_),
    .B2(_221_),
    .ZN(_222_));
 AOI21_X1 _556_ (.A(_198_),
    ...
    .B2(_222_),
    .ZN(_004_));
 NOR3_X1 _557_ (.A1(net260),
    .A2(net262),
    .A3(net263),
    .ZN(_223_));
 NAND2_X1 _558_ (.A1(net211),
    .A2(net208),
    .ZN(_224_));
 AOI221_X2 _559_ (.A(_224_),
    ...
    .C2(net180),
    .ZN(_225_));
 NAND2_X1 _560_ (.A1(net260),
    .A2(net175),
    .ZN(_226_));
 NOR2_X1 _561_ (.A1(_226_),
    .A2(net169),
    .ZN(_227_));
 NOR2_X1 _562_ (.A1(_212_),
    .A2(net173),
    .ZN(_228_));
 NAND3_X1 _563_ (.A1(_211_),
    ...
    .A3(_139_),
    .ZN(_229_));
 OAI22_X1 _564_ (.A1(net208),
    .A2(net262),
    .B1(_228_),
    .B2(_229_),
    .ZN(_230_));
 NOR4_X2 _565_ (.A1(net263),
    .A2(_225_),
    .A3(_227_),
    .A4(_230_),
    .ZN(_231_));
 NAND2_X1 _566_ (.A1(net241),
    .A2(_003_),
    .ZN(_232_));
 NAND3_X1 _567_ (.A1(net241),
    .A2(net208),
    .A3(net176),
    .ZN(_233_));
 ...
 NAND2_X1 _573_ (.A1(\ctrl.state.out[2] ),
    .A2(_068_),
    .ZN(_238_));
 AND4_X1 _577_ (.A1(net239),
    .A2(_003_),
    .A3(net169),
    .A4(_215_),
    .ZN(_242_));
 AOI21_X2 _578_ (.A(_242_),
    .B1(net166),
    .B2(net39),
    .ZN(_243_));
 ...
 AOI21_X1 _581_ (.A(_244_),
    ...
    .B2(net263),
    .ZN(_245_));
 AND4_X1 _582_ (.A1(net238),
    .A2(_003_),
    .A3(net490),
    .A4(_215_),
    .ZN(_246_));
 AOI21_X2 _583_ (.A(_246_),
    .B1(net166),
    .B2(net172),
    .ZN(_247_));
 OAI21_X1 _584_ (.A(_245_),
    ...
    .B2(net187),
    .ZN(_007_));
 NOR3_X1 _585_ (.A1(net204),
    .A2(net262),
    .A3(net263),
    .ZN(_248_));
 INV_X1 _586_ (.A(_238_),
    .ZN(_249_));
 AND3_X1 _587_ (.A1(net236),
    .A2(_003_),
    .A3(_249_),
    .ZN(_250_));
 ...
 OAI21_X1 _593_ (.A(_254_),
    ...
    .B2(_068_),
    .ZN(_255_));
 AOI21_X1 _594_ (.A(net187),
    .B1(_003_),
    .B2(net235),
    .ZN(_256_));
 NOR2_X1 _595_ (.A1(net167),
    .A2(net187),
    .ZN(_257_));
 ...
 MUX2_X1 _600_ (.A(net25),
    ...
    .S(net222),
    .Z(_010_));
 NAND3_X1 _601_ (.A1(net251),
    .A2(net223),
    .A3(net222),
    .ZN(_261_));
 AND4_X1 _602_ (.A1(net234),
    .A2(_003_),
    .A3(net170),
    .A4(net168),
    .ZN(_262_));
 ...
 NAND3_X1 _606_ (.A1(net250),
    ...
    .A3(net222),
    .ZN(_265_));
 AND4_X1 _607_ (.A1(net536),
    .A2(_003_),
    .A3(net170),
    .A4(net168),
    .ZN(_266_));
 AOI21_X1 _608_ (.A(_266_),
    .B1(net166),
    .B2(net45),
    .ZN(_267_));
 ...
 NAND3_X1 _611_ (.A1(net249),
    ...
    .A3(net222),
    .ZN(_269_));
 AND4_X1 _612_ (.A1(net232),
    .A2(_003_),
    .A3(net170),
    .A4(net168),
    .ZN(_270_));
 AOI21_X2 _613_ (.A(_270_),
    .B1(net166),
    .B2(net46),
    .ZN(_271_));
 ...
 OAI221_X1 _640_ (.A(_289_),
    ...
    .C2(_292_),
    .ZN(_018_));
 NAND3_X1 _641_ (.A1(net243),
    .A2(_062_),
    .A3(net222),
    .ZN(_293_));
 AND4_X1 _642_ (.A1(net224),
    .A2(_003_),
    .A3(net169),
    .A4(net168),
    .ZN(_294_));
 ...
 OAI21_X4 _647_ (.A(_003_),
    ...
    .B2(_062_),
    .ZN(_298_));
 MUX2_X1 _649_ (.A(net242),
    .B(_297_),
    .S(net275),
    .Z(_020_));
 MUX2_X1 _650_ (.A(net260),
    .B(net2),
    .S(net263),
    .Z(_300_));
 MUX2_X1 _651_ (.A(net241),
    .B(_300_),
    .S(net276),
    .Z(_021_));
 MUX2_X1 _652_ (.A(net258),
    .B(net3),
    .S(net263),
    .Z(_301_));
 MUX2_X1 _653_ (.A(\dpath.a_lt_b$in1[11] ),
    .B(_301_),
    .S(net275),
    .Z(_022_));
 MUX2_X1 _654_ (.A(\dpath.a_lt_b$in0[12] ),
    ...
    .S(net263),
    .Z(_302_));
 MUX2_X1 _655_ (.A(net238),
    .B(_302_),
    .S(net275),
    .Z(_023_));
 MUX2_X1 _656_ (.A(net254),
    .B(net5),
    .S(net263),
    .Z(_303_));
 MUX2_X1 _657_ (.A(net236),
    .B(_303_),
    .S(net275),
    .Z(_024_));
 ...
 BUF_X1 output53 (.A(net53),
    .Z(resp_val));
 BUF_X1 place165 (.A(_166_),
    .Z(net165));
 BUF_X16 place166 (.A(_218_),
    .Z(net166));
 BUF_X2 place167 (.A(_216_),
    .Z(net167));
 BUF_X2 place168 (.A(_215_),
    .Z(net168));
 BUF_X4 place169 (.A(_210_),
    .Z(net169));
 BUF_X4 place170 (.A(_210_),
    .Z(net170));
 BUF_X1 place171 (.A(_196_),
    .Z(net171));
 BUF_X1 place172 (.A(net403),
    .Z(net172));
 BUF_X1 place173 (.A(_214_),
    .Z(net173));
 BUF_X4 place174 (.A(_150_),
    .Z(net174));
 BUF_X2 place175 (.A(_139_),
    .Z(net175));
 BUF_X1 place176 (.A(net487),
    .Z(net176));
 BUF_X1 place177 (.A(_153_),
    .Z(net177));
 BUF_X1 place178 (.A(_135_),
    .Z(net178));
 BUF_X1 place180 (.A(_137_),
    .Z(net180));
 BUF_X4 place182 (.A(_092_),
    .Z(net182));
 BUF_X1 place183 (.A(_145_),
    .Z(net183));
 BUF_X1 place184 (.A(net185),
    .Z(net184));
 BUF_X2 place185 (.A(_118_),
    .Z(net185));
 BUF_X4 place186 (.A(_079_),
    .Z(net186));
 BUF_X2 place187 (.A(_238_),
    .Z(net187));
 BUF_X1 place188 (.A(_184_),
    .Z(net188));
 BUF_X1 place189 (.A(_182_),
    .Z(net189));
 BUF_X1 place190 (.A(_173_),
    .Z(net190));
 BUF_X1 place191 (.A(_146_),
    .Z(net191));
 BUF_X1 place192 (.A(_142_),
    .Z(net192));
 BUF_X1 place193 (.A(_125_),
    .Z(net193));
 BUF_X1 place194 (.A(_119_),
    .Z(net194));
 BUF_X4 place195 (.A(_078_),
    .Z(net195));
 BUF_X2 place196 (.A(_077_),
    .Z(net196));
 BUF_X1 place197 (.A(_213_),
    .Z(net197));
 BUF_X1 place198 (.A(_183_),
    .Z(net198));
 BUF_X1 place199 (.A(_180_),
    .Z(net199));
 BUF_X1 place200 (.A(_169_),
    .Z(net200));
 BUF_X1 place201 (.A(net202),
    .Z(net201));
 BUF_X2 place202 (.A(_169_),
    .Z(net202));
 BUF_X1 place203 (.A(_168_),
    .Z(net203));
 BUF_X1 place204 (.A(_168_),
    .Z(net204));
 BUF_X1 place205 (.A(_162_),
    .Z(net205));
 BUF_X1 place206 (.A(_161_),
    .Z(net206));
 BUF_X1 place207 (.A(_159_),
    .Z(net207));
 BUF_X1 place208 (.A(_147_),
    .Z(net208));
 BUF_X1 place209 (.A(_143_),
    .Z(net209));
 BUF_X1 place210 (.A(_141_),
    .Z(net210));
 BUF_X1 place211 (.A(net212),
    .Z(net211));
 BUF_X1 place212 (.A(_132_),
    .Z(net212));
 BUF_X1 place213 (.A(_123_),
    .Z(net213));
 BUF_X1 place214 (.A(_114_),
    .Z(net214));
 BUF_X1 place215 (.A(_111_),
    .Z(net215));
 BUF_X1 place216 (.A(_111_),
    .Z(net216));
 BUF_X1 place217 (.A(_108_),
    .Z(net217));
 BUF_X1 place218 (.A(_096_),
    .Z(net218));
 BUF_X1 place219 (.A(_094_),
    .Z(net219));
 BUF_X2 place220 (.A(_083_),
    .Z(net220));
 BUF_X4 place221 (.A(_081_),
    .Z(net221));
 BUF_X1 place222 (.A(_068_),
    .Z(net222));
 BUF_X1 place223 (.A(_062_),
    .Z(net223));
 ...
 BUF_X1 place226 (.A(\dpath.a_lt_b$in1[7] ),
    .Z(net226));
 BUF_X1 place227 (.A(net228),
    .Z(net227));
 BUF_X2 place228 (.A(\dpath.a_lt_b$in1[6] ),
    .Z(net228));
 BUF_X1 place229 (.A(\dpath.a_lt_b$in1[6] ),
    .Z(net229));
 BUF_X1 place230 (.A(\dpath.a_lt_b$in1[5] ),
    .Z(net230));
 BUF_X1 place231 (.A(\dpath.a_lt_b$in1[4] ),
    .Z(net231));
 BUF_X1 place232 (.A(\dpath.a_lt_b$in1[3] ),
    .Z(net232));
 BUF_X4 place233 (.A(\dpath.a_lt_b$in1[2] ),
    .Z(net233));
 BUF_X4 place234 (.A(\dpath.a_lt_b$in1[1] ),
    .Z(net234));
 BUF_X1 place235 (.A(\dpath.a_lt_b$in1[14] ),
    .Z(net235));
 BUF_X1 place236 (.A(\dpath.a_lt_b$in1[13] ),
    .Z(net236));
 BUF_X1 place237 (.A(\dpath.a_lt_b$in1[13] ),
    .Z(net237));
 BUF_X1 place238 (.A(\dpath.a_lt_b$in1[12] ),
    .Z(net238));
 BUF_X1 place239 (.A(net240),
    .Z(net239));
 BUF_X2 place240 (.A(\dpath.a_lt_b$in1[11] ),
    .Z(net240));
 BUF_X1 place241 (.A(\dpath.a_lt_b$in1[10] ),
    .Z(net241));
 BUF_X1 place242 (.A(\dpath.a_lt_b$in1[0] ),
    .Z(net242));
 BUF_X1 place243 (.A(\dpath.a_lt_b$in0[9] ),
    .Z(net243));
 BUF_X1 place244 (.A(\dpath.a_lt_b$in0[8] ),
    .Z(net244));
 BUF_X2 place245 (.A(\dpath.a_lt_b$in0[7] ),
    .Z(net245));
 BUF_X1 place246 (.A(\dpath.a_lt_b$in0[6] ),
    .Z(net246));
 BUF_X1 place247 (.A(\dpath.a_lt_b$in0[5] ),
    .Z(net247));
 BUF_X1 place248 (.A(\dpath.a_lt_b$in0[4] ),
    .Z(net248));
 BUF_X2 place249 (.A(\dpath.a_lt_b$in0[3] ),
    .Z(net249));
 BUF_X2 place250 (.A(\dpath.a_lt_b$in0[2] ),
    .Z(net250));
 BUF_X2 place251 (.A(\dpath.a_lt_b$in0[1] ),
    .Z(net251));
 BUF_X1 place252 (.A(\dpath.a_lt_b$in0[15] ),
    .Z(net252));
 BUF_X1 place253 (.A(\dpath.a_lt_b$in0[14] ),
    .Z(net253));
 BUF_X1 place254 (.A(\dpath.a_lt_b$in0[13] ),
    .Z(net254));
 BUF_X1 place255 (.A(\dpath.a_lt_b$in0[13] ),
    .Z(net255));
 BUF_X4 place256 (.A(\dpath.a_lt_b$in0[12] ),
    .Z(net256));
 BUF_X1 place257 (.A(\dpath.a_lt_b$in0[12] ),
    .Z(net257));
 BUF_X1 place258 (.A(\dpath.a_lt_b$in0[11] ),
    .Z(net258));
 BUF_X2 place259 (.A(\dpath.a_lt_b$in0[10] ),
    .Z(net259));
 BUF_X1 place260 (.A(\dpath.a_lt_b$in0[10] ),
    .Z(net260));
 BUF_X2 place261 (.A(\dpath.a_lt_b$in0[0] ),
    .Z(net261));
 BUF_X2 place262 (.A(\ctrl.state.out[2] ),
    .Z(net262));
 BUF_X4 place263 (.A(net36),
    .Z(net263));
 BUF_X4 rebuffer264 (.A(net488),
    .Z(net264));
 BUF_X4 rebuffer267 (.A(net520),
    .Z(net267));
 BUF_X2 rebuffer268 (.A(_156_),
    .Z(net268));
 BUF_X4 rebuffer275 (.A(_298_),
    .Z(net275));
 BUF_X4 rebuffer276 (.A(_298_),
    .Z(net276));
 BUF_X4 rebuffer336 (.A(net404),
    .Z(net336));
 BUF_X2 rebuffer392 (.A(\dpath.a_lt_b$in0[1] ),
    .Z(net392));
 BUF_X1 rebuffer402 (.A(_186_),
    .Z(net402));
 BUF_X1 rebuffer403 (.A(net40),
    .Z(net403));
 BUF_X1 rebuffer404 (.A(_157_),
    .Z(net404));
 BUF_X1 rebuffer487 (.A(_138_),
    .Z(net487));
 BUF_X1 rebuffer488 (.A(_107_),
    .Z(net488));
 BUF_X4 rebuffer489 (.A(net264),
    .Z(net489));
 BUF_X1 rebuffer490 (.A(net169),
    .Z(net490));
 BUF_X1 rebuffer520 (.A(_120_),
    .Z(net520));
 BUF_X1 rebuffer535 (.A(net48),
    .Z(net535));
 BUF_X1 rebuffer536 (.A(net233),
    .Z(net536));
 BUF_X1 rebuffer537 (.A(net233),
    .Z(net537));
 BUF_X4 rebuffer552 (.A(net186),
    .Z(net552));
endmodule
