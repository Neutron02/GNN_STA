#!/usr/bin/env python3
"""Evaluate a trained hetero dual-pass timing model checkpoint."""
...
from train_hetero_dualpass import (
    DualPassHeteroTimingNet,
    HeteroNormStats,
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Evaluate trained hetero dual-pass checkpoint")
    ...
    if not isinstance(cell_vocab, dict):
        cell_vocab = {}
    stats = HeteroNormStats.from_dict(ckpt["normalization"])
